...
import edu.wctc.bmh.bookapp2.model.service.AbstractFacade;
...
public class AuthorController extends HttpServlet {
    ...
    @Inject
    private AbstractFacade authService;
    ...
    private void delete(final HttpServletRequest request) throws Exception {
        ...
        authService.remove(authService.find(Integer.valueOf(deleteId)));
        destination = READ_PAGE;
